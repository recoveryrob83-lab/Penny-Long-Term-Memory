"""Preview signed Worker results ready for Chief of Staff consumption."""
...
RECEIPT_PREFIX = "LIFEOS_COS_CONSUMPTION_PREVIEW="
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        preview = service.preview(args.run_ids)
    ...
    print("COS_CONSUMPTION_PREVIEW_OK")
