      ...
      <main class="dashboard-grid">
        <section class="panel automation-logs-panel" aria-labelledby="automation-logs-heading">
          ...
          <div class="automation-log-toolbar" aria-label="Automation log filters">
            ...
            <label class="cc-filter-field">Trigger<select id="automation-log-filter-trigger"><option value="all">Manual and scheduled</option><option value="manual">Manual</option><option value="scheduled">Scheduled</option><option value="legacy">Legacy</option><option value="unknown">Unknown</option></select></label>
