...
|---|---|---|---:|---|---|---|---|---|
| ADV-20260718-042 | OPEN | HIGH | 1 | IMMEDIATE_HQ | Chief_of_Staff_HQ / LifeOS_HQ | Engineering_HQ | `coordination/boards/main-assistant.md` | Require receiver-side semantic validation before Worker execution |
