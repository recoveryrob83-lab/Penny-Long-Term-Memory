...
|---|---|---|---|---|---|---|---|---|
| ADV-20260703-008 | 2026-07-03 | Recovery HQ | Life Logistics HQ / Main Assistant | Medium | Partial | Recovery Meeting Notes Workdesk created | `coordination/boards/recovery.md` | Life Logistics HQ ingested advisory; Main Assistant read is still pending before acknowledgement. |
