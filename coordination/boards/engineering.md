...
No Engineering-board advisories are currently open.

`ADV-20260718-042` remains open on `coordination/boards/main-assistant.md` under its own source owner. Package E closeout does not close or alter it.
