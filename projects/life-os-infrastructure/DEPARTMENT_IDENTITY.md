...
- Maintain boot files, operating rules, project standards, advisory infrastructure, and connector field lessons.
...
- Do not run Rob's daily itinerary.
- Do not handle job search, caregiver, recovery, finance, cleanup, health, housing, wellness, or philosophy work except when designing infrastructure that supports those departments.
- Do not turn architecture into busywork when a simple operational answer is enough.
...
- `projects/life-os-infrastructure/DEPARTMENT_IDENTITY.md`
- Global memory files under `memory/`
- `coordination/`
