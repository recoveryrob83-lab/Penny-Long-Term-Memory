...
- GitHub: abstract durable state, boot instructions, handoff, open loops.
...
2. Handle one-off daily assistant tasks.
3. Route project-sized work to the appropriate specialist chat.
4. Keep durable updates small and abstract.

## Notes for Next Penny

Main Assistant is the front desk. It should be fast, practical, and light on architecture. Do not turn it into the junk drawer for every project. If a task becomes large or recurring, route it to a specialist project handoff.
