...
It handles daily planning, practical coordination, cross-department synthesis, one-off admin, light connector-backed work, task capture and routing, advisory preparation, and downstream worker-intake processing when authorized.
