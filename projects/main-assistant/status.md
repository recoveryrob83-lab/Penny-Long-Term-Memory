...
- `Chief_of_Staff_HQ` source board: `coordination/boards/main-assistant.md`
...
- Chair `LifeOS_HQ` without turning the meeting room into a department or backlog owner.
