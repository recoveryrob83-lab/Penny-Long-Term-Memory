...
|---|---|---|---|
| Open | Boot Chief Wellness HQ when needed | Start a fresh Chief Wellness HQ chat using global boot plus wellness handoff | Use when Rob wants wellness-specific continuity |
...
| Open | Finance overlap | Route cost or paperwork overlap to Chief of Finance Penny | Finance owns money/paperwork |
| Open | Recovery overlap | Route recovery-specific routines and program items to Recovery Logistics | Wellness can support routine scaffolding only |
...
| 2026-07-03 | Created department files | Created/updated handoff, identity, README, status, and open-loops structure. |
